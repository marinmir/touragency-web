module touragency/api/v1/tours

go 1.17

replace touragency/model => ./../../../model

replace touragency/api/v1/aviatickets => ./../aviatickets

replace touragency/api/v1/countries => ./../countries

replace touragency/api/v1/hotel_bookings => ./../hotel_bookings

replace touragency/api/v1/tour_clients => ./../tour_clients

replace touragency/api/v1/tour_managers => ./../tour_managers

replace touragency/api/v1/tour_operators => ./../tour_operators
